...
(function (n, t) {
  ...
  var n = {};n.VERSION = "0.8.0";n.not = {};n.all = {};n.any = {};var t = Object.prototype.toString;var e = Array.prototype.slice;var r = Object.prototype.hasOwnProperty;function a(n) {
    return function () {
      return !n.apply(null, e.call(arguments));
    };
  }function u(n) {
    return function () {
      var t = c(arguments);var e = t.length;for (var r = 0; r < e; r++) {
        if (!n.call(null, t[r])) {
          return false;
        }
      }return true;
    ...
    var e = t + "";var r = +(e.match(/\d+/) || NaN);var a = e.match(/^[<>]=?|/)[0];return i[a] ? i[a](n, r) : n == r || r !== r;
  }function c(t) {
    var r = e.call(t);var a = r.length;if (a === 1 && n.array(r[0])) {
      r = r[0];
    }return r;
  }n.arguments = function (n) {
    return t.call(n) === "[object Arguments]" || n != null && (typeof n === "undefined" ? "undefined" : _typeof(n)) === "object" && "callee" in n;
    ...
    return n != null && (typeof n === "undefined" ? "undefined" : _typeof(n)) === "object" && "setInterval" in n;
  };n.empty = function (t) {
    if (n.object(t)) {
      var e = Object.getOwnPropertyNames(t).length;if (e === 0 || e === 1 && n.array(t) || e === 2 && n.arguments(t)) {
        return true;
      }return false;
    }return t === "";
  };n.existy = function (n) {
    ...
    if (n.not.string(t)) {
      return false;
    }var e = t.split(" ");for (var r = 0; r < e.length; r++) {
      var a = e[r];if (a.length) {
        var u = a.charAt(0);if (u !== u.toUpperCase()) {
          return false;
        }
      }
    }return true;
  ...
  };n.endWith.api = ["not"];n.include = function (n, t) {
    ...
    if (n.not.string(t)) {
      return false;
    }t = t.replace(/[^a-zA-Z0-9]+/g, "").toLowerCase();var e = t.length - 1;for (var r = 0, a = Math.floor(e / 2); r <= a; r++) {
    ...
    if (n.not.char(t)) {
      return false;
    }var e = t.charCodeAt(0);return e > 8 && e < 14 || e === 32;
  ...
  };var F = ["sunday", "monday", "tuesday", "wednesday", "thursday", "friday", "saturday"];var p = ["january", "february", "march", "april", "may", "june", "july", "august", "september", "october", "november", "december"];n.day = function (t, e) {
    return n.date(t) && e.toLowerCase() === F[t.getDay()];
  };n.day.api = ["not"];n.dayLightSavingTime = function (n) {
    var t = new Date(n.getFullYear(), 0, 1);var e = new Date(n.getFullYear(), 6, 1);var r = Math.max(t.getTimezoneOffset(), e.getTimezoneOffset());return n.getTimezoneOffset() < r;
  };n.future = function (t) {
    var e = new Date();return n.date(t) && t.getTime() > e.getTime();
  };n.inDateRange = function (t, e, r) {
    if (n.not.date(t) || n.not.date(e) || n.not.date(r)) {
      return false;
    }var a = t.getTime();return a > e.getTime() && a < r.getTime();
    ...
    var e = new Date();var r = e.toDateString();return n.date(t) && t.toDateString() === r;
  };n.tomorrow = function (t) {
    var e = new Date();var r = new Date(e.setDate(e.getDate() + 1)).toDateString();return n.date(t) && t.toDateString() === r;
    ...
    var e = new Date();var r = new Date(e.setDate(e.getDate() - 1)).toDateString();return n.date(t) && t.toDateString() === r;
  };var D = n.windowObject((typeof global === "undefined" ? "undefined" : _typeof(global)) == "object" && global) && global;var h = n.windowObject((typeof self === "undefined" ? "undefined" : _typeof(self)) == "object" && self) && self;var v = n.windowObject(_typeof(this) == "object" && this) && this;var b = D || h || v || Function("return this")();var g = h && h.document;var m = b.is;var w = h && h.navigator;var y = (w && w.appVersion || "").toLowerCase();var x = (w && w.userAgent || "").toLowerCase();var A = (w && w.vendor || "").toLowerCase();n.android = function () {
    ...
    var t = /google inc/.test(A) ? x.match(/(?:chrome|crios)\/(\d+)/) : null;return t !== null && f(t[1], n);
  };n.chrome.api = ["not"];n.desktop = function () {
    return n.not.mobile() && n.not.tablet();
  };n.desktop.api = ["not"];n.edge = function (n) {
    var t = x.match(/edge\/(\d+)/);return t !== null && f(t[1], n);
  };n.edge.api = ["not"];n.firefox = function (n) {
    var t = x.match(/(?:firefox|fxios)\/(\d+)/);return t !== null && f(t[1], n);
  };n.firefox.api = ["not"];n.ie = function (n) {
    var t = x.match(/(?:msie |trident.+?; rv:)(\d+)/);return t !== null && f(t[1], n);
  };n.ie.api = ["not"];n.ios = function () {
    return n.iphone() || n.ipad() || n.ipod();
  };n.ios.api = ["not"];n.ipad = function (n) {
    var t = x.match(/ipad.+?os (\d+)/);return t !== null && f(t[1], n);
  };n.ipad.api = ["not"];n.iphone = function (n) {
    var t = x.match(/iphone(?:.+?os (\d+))?/);return t !== null && f(t[1] || 1, n);
  };n.iphone.api = ["not"];n.ipod = function (n) {
    var t = x.match(/ipod.+?os (\d+)/);return t !== null && f(t[1], n);
    ...
    var t = x.match(/(?:^opera.+?version|opr)\/(\d+)/);return t !== null && f(t[1], n);
  };n.opera.api = ["not"];n.phantom = function (n) {
    var t = x.match(/phantomjs\/(\d+)/);return t !== null && f(t[1], n);
  };n.phantom.api = ["not"];n.safari = function (n) {
    var t = x.match(/version\/(\d+).+?safari/);return t !== null && f(t[1], n);
    ...
    if (n.not.array(t)) {
      return false;
    }var r = i[e] || i[">="];for (var a = 1; a < t.length; a++) {
      if (!r(t[a], t[a - 1])) {
        return false;
      }
    }return true;
  };function j() {
    var t = n;for (var e in t) {
      if (r.call(t, e) && n["function"](t[e])) {
        var i = t[e].api || ["not", "all", "any"];for (var f = 0; f < i.length; f++) {
          if (i[f] === "not") {
            n.not[e] = a(n[e]);
          }if (i[f] === "all") {
            n.all[e] = u(n[e]);
